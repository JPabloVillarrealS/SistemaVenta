...
namespace SistemaVenta.BLL.Servicios
{
    ...
    {
        private readonly IGenericRepository<Usuario> _usuarioReposirotio;
        ...
        public MenuService(IGenericRepository<Usuario> usuarioReposirotio, 
            IGenericRepository<MenuRol> menuRolRepositorio, 
            IGenericRepository<Menu> menuRepositorio, IMapper mapper)
        {
            _usuarioReposirotio = usuarioReposirotio;
        ...
        public async Task<List<MenuDTO>> Lista(int idUsuario)
        {
            ...
            IQueryable<Usuario> tbUsuario = await _usuarioReposirotio.Consultar(u => u.IdUsuario == idUsuario);
