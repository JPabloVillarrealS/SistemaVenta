...
public partial class DbventaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240CB1530736");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843F769A3334");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF483BE9128DC");
        ...
        {
            entity.HasKey(e => e.IdMenuRol).HasName("PK__MenuRol__9D6D61A4BAEC8557");
        ...
        {
            entity.HasKey(e => e.IdNumeroDocumento).HasName("PK__NumeroDo__471E421AC87893A2");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A132F4F1AB2A");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F763B70FBEE");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A6E0B0347B");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D5614DD02DE98");
